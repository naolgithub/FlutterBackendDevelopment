...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _connectSocket() {
    _socket.onConnect((data) => debugPrint('Connection established'));
    _socket.onConnectError((data) => debugPrint('Connect Error: $data'));
    _socket.onDisconnect((data) => debugPrint('Socket.IO server disconnected'));
    _socket.on(
      'message',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Simple socket.io chat'),
      ),
      body: Column(
        children: [
          Expanded(
