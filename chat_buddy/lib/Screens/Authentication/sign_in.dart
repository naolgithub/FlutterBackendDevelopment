...
import 'package:chat_buddy/Logic/cubit_logic.dart';
import 'package:chat_buddy/Screens/Authentication/sign_up.dart';
import 'package:chat_buddy/auxilaries/colors.dart';
...
class _SigninState extends State<Signin> {
  ...
  Widget_formField(
      String field, bool isObscure, TextEditingController controller) {
    return SizedBox(
  ...
  Widget build(BuildContext context) {
    context
        ...
        .getSnapshotValue(context.read<InputSearchCubit>().state);
    return Scaffold(
      appBar: AppBar(
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        if (_formkey.currentState!.validate()) {
                          ...
                          if (!context.read<GetUsersListCubit>().state.contains(
