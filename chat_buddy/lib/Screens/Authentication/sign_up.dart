...
class _SignupState extends State<Signup> {
  ...
  Widget _formField(String field, bool isObscure,
      TextEditingController controller, String saveTo) {
    return SizedBox(
  ...
  saveUser() async {
    Map userDetails =
        createUserDetails(_nameController.text, _emailController.text);
  ...
  void signUp() async {
    ...
    try {
      ...
      context
          ...
          .getSnapshotValue(_userNameController.text);
    ...
    return context.read<GetUsersListCubit>().state == []
        ...
        : Scaffold(
            appBar: AppBar(
              ...
              title: const Text("Sign-Up to Chat-buddy",
