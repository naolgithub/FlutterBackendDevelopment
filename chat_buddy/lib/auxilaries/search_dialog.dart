...
createMessagesList(BuildContext context, String userName) {
  ...
  FirebaseDatabase.instance
      ...
      .child("receivedList/$Currentuser/")
      .set({"123": Currentuser});
  FirebaseDatabase.instance
      .ref("usersData/$userName")
      ...
      builder: ((context) {
        ...
        return AlertDialog(
            shape: RoundedRectangleBorder(
                side: BorderSide(color: colors1[9]),
                      ...
                      TextField(
                        ...
                        onChanged: (value) {
                          ...
                          context
                              ...
                              .startInputing(searchEditingController.text);
                                            ...
                                            child: Hero(
                                              ...
                                              child: GestureDetector(
                                                behavior: HitTestBehavior
                                                    .translucent, //to detect tap on whole container
                                                onTap: (() {
                                                  Navigator.pop(context);

                                                  if (chatUsers.contains(
                                                          listToBeDisplayed[
                                                              index]) ==
                                                      false) {
                                                    createMessagesList(
