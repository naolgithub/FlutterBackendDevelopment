...
class ProfilePage extends StatefulWidget {
  ...
  const ProfilePage(
      {Key? key, required this.firestore, required this.firebaseAuth})
      : super(key: key);

  @override
  State<ProfilePage> createState() => _ProfilePageState(firebaseAuth);
}
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  _ProfilePageState(FirebaseAuth firebaseAuth) {
    ...
    authService = AuthService.fromParam(this.firebaseAuth);
  }
